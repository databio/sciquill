...
\titleformat{\section}
  {\normalfont\fontfamily{phv}\fontsize{12pt}{12pt}\selectfont\color{bluetint2}\bfseries}{\thesection}{1em}{}

\titleformat{\subsection}
  {\normalfont\fontfamily{phv}\fontsize{11pt}{20pt}\selectfont\color{black}\bfseries}{\thesubsection}{1em}{}

\titleformat{\subsubsection}
  {\normalfont\fontfamily{phv}\fontsize{11pt}{11pt}\selectfont\color{lightblack}\itshape}{\thesubsubsection}{1em}{}


% \titlespacing{command}{left spacing}{before spacing}{after spacing}[right]
\titlespacing\section{0pt}{14pt plus 4pt minus 4pt}{0pt plus 3pt minus 1pt}
\titlespacing\subsection{0pt}{12pt plus 4pt minus 4pt}{0pt plus 3pt minus 3pt}
\titlespacing\subsubsection{0pt}{12pt plus 4pt minus 6pt}{-4pt plus 4pt minus 4pt}
...
\newcommand{\piinfo}
{\begin{footnotesize}\begin{flushright}OMB No. 0925-0001 and 0925-0002 (Rev. 10/2021 Approved Through 09/30/2024)\end{flushright}\end{footnotesize}\vspace{-1em}\pgline
{\centering
...
EDUCATION/TRAINING \vspace{0.5em}\\}

% Do we really need this note in the form? It looks bad. Let's clean it up and see if anyone complains. 
% (\textit{Begin with baccalaureate or other initial professional education, such as nursing, include postdoctoral training and residency training if applicable. Add/delete rows as necessary.})
