...
\fi
\hypersetup{breaklinks=true, pdfborder={0 0 0}, colorlinks=true, urlcolor=bluehaze, linkcolor=bluehaze}
$if(strikeout)$
...
\titleformat{\section}
  {\normalfont\fontfamily{phv}\fontsize{12pt}{12pt}\selectfont\color{black}\bfseries}{\thesection}{1em}{}
...
\usepackage{csquotes}
\AtBeginEnvironment{quote}{\itshape\color{bluehaze}\vspace{-1.5\baselineskip}}
\AtEndEnvironment{quote}{\vspace{-1\baselineskip}}
...
\providecommand{\tightlist}{%
  ...
  \setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}\addtolength{\itemindent}{-20pt}\addtolength{\leftmargin}{-20pt}\setlength{\parindent}{-26pt}
