...
\RequirePackage[top=0.8in,left=0.8in,right=0.8in,bottom=0.8in]{geometry}
...
\lfoot{\scriptsize \thepage \middot \textit{Databio Proceedings} \middot $if(date)$ \textsl{$date$} $endif$ \textcopyright The Authors}
\usepackage{fancyhdr}
\pagestyle{fancy}
\usepackage{titlesec}
...
\newmdenv[linecolor=white, fontcolor=bluetint, backgroundcolor=graybit, leftmargin=8, rightmargin=8, innertopmargin=8, innerbottommargin=8, innerleftmargin=12, innerrightmargin=12, roundcorner=10pt]{infobox}
